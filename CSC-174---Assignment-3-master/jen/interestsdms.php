...
<html lang="en">
   <head>
      ...
      <title>Jennifer Ngene | Assignment 3: Information Architecture</title>
   ...
   <body >   
      <div class="body">
         <nav class="navbar">
                  ...
                  <a class="nav-element" href="now_dms.php">DMS</a>
                  <a class="nav-element" href="jen.php">Main</a>
                  <a class="nav-element" href="../index.php">Home</a>    
         </nav>
         <header>
            <img href="kat.php" src="../images/jen.jpg" alt="kat">
            <h1 style="text-decoration: none">Jennifer Ngene</h1>
            <hr>
            <h2> DMS Major - Class of 2021</h2>
         </header>
